...
def migrate(c):
    c.execute("CREATE TABLE IF NOT EXISTS social_accounts (id INTEGER PRIMARY KEY AUTOINCREMENT, organization_id INTEGER NOT NULL, provider TEXT NOT NULL, provider_user_id TEXT NOT NULL, username TEXT NOT NULL DEFAULT '', display_name TEXT NOT NULL DEFAULT '', avatar_url TEXT NOT NULL DEFAULT '', access_token_enc TEXT NOT NULL, refresh_token_enc TEXT NOT NULL DEFAULT '', expires_at TEXT, status TEXT NOT NULL DEFAULT 'connected', last_synced_at TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, UNIQUE(organization_id,provider))")
    c.execute("CREATE TABLE IF NOT EXISTS social_posts (id INTEGER PRIMARY KEY AUTOINCREMENT, organization_id INTEGER NOT NULL, social_account_id INTEGER NOT NULL, text TEXT NOT NULL, media_url TEXT NOT NULL DEFAULT '', status TEXT NOT NULL, provider_post_id TEXT NOT NULL DEFAULT '', post_url TEXT NOT NULL DEFAULT '', error_message TEXT NOT NULL DEFAULT '', created_at TEXT NOT NULL, published_at TEXT)")
