...
<style>body{margin:0;background:#071126;color:#fff;font-family:Tahoma;padding:24px}.wrap{max-width:900px;margin:auto}.card{background:#111f42;border:1px solid #1d4f7a;border-radius:20px;padding:22px;margin-bottom:14px}h1{color:#28c7ff}input,select,button{box-sizing:border-box;width:100%;padding:13px;margin:7px 0;border-radius:10px;border:1px solid #285682;background:#09152e;color:#fff}button{background:#0284c7;font-weight:bold;cursor:pointer}.vip{background:#d97706}.result{color:#7dd3fc;white-space:pre-wrap}.service-row{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:13px;margin:9px 0;background:#0b1733;border:1px solid #285682;border-radius:14px}.service-row small{display:block;color:#94a3b8;margin-top:5px}.switch{position:relative;display:inline-block;width:58px;height:32px;flex:0 0 58px}.switch input{opacity:0;width:0;height:0;margin:0;padding:0}.slider{position:absolute;inset:0;cursor:pointer;background:#334155;border-radius:32px;transition:.2s}.slider:before{content:"";position:absolute;width:24px;height:24px;right:4px;top:4px;background:white;border-radius:50%;transition:.2s}.switch input:checked+.slider{background:#0ea5e9;box-shadow:0 0 14px #0ea5e999}.switch input:checked+.slider:before{transform:translateX(-26px)}</style></head><body><div class="wrap"><h1>لوحة مالك خدووم</h1>
