...
<button class="category-button" onclick="showSecurityPanel('emergencyPanel')">الطوارئ<span>تشغيل الخدمات</span></button>
</div>
...
<section id="devicesPanel" class="security-panel"><div class="card"><h2>الأجهزة والجلسات</h2><p class="muted">كل جهاز موضح معه اسم المؤسسة والمستخدم.</p><div id="devices"></div></div><div class="card"><h2>الأجهزة المحظورة</h2><div id="blockedDevices"></div></div></section>
