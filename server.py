...
<style>body{margin:0;background:#071126;color:#fff;font-family:Tahoma;padding:24px}.wrap{max-width:900px;margin:auto}.card{background:#111f42;border:1px solid #1d4f7a;border-radius:20px;padding:22px;margin-bottom:14px}h1{color:#28c7ff}input,select,button{box-sizing:border-box;width:100%;padding:13px;margin:7px 0;border-radius:10px;border:1px solid #285682;background:#09152e;color:#fff}button{background:#0284c7;font-weight:bold;cursor:pointer}.vip{background:#d97706}.result{color:#7dd3fc;white-space:pre-wrap}.service-row{direction:rtl;display:flex;align-items:center;justify-content:space-between;gap:20px;min-height:66px;padding:16px 18px;margin:12px 0;background:linear-gradient(135deg,#173a86,#11275f);border:1px solid #2563eb;border-radius:18px;box-shadow:0 8px 20px #02061755}.service-row b{font-size:17px}.service-row small{display:block;color:#bfdbfe;margin-top:6px;font-size:13px}.switch{position:relative;display:inline-block;width:72px;height:40px;flex:0 0 72px}.switch input{opacity:0;width:0;height:0;margin:0;padding:0}.slider{position:absolute;inset:0;cursor:pointer;background:#334155;border-radius:40px;transition:.25s;box-shadow:inset 0 0 0 1px #64748b}.slider:before{content:"";position:absolute;width:32px;height:32px;right:4px;top:4px;background:#e2e8f0;border-radius:50%;transition:.25s;box-shadow:0 2px 8px #02061799}.switch input:checked+.slider{background:#00b8f5;box-shadow:0 0 18px #00b8f5aa,inset 0 0 0 1px #67e8f9}.switch input:checked+.slider:before{transform:translateX(-32px);background:#bff6ff}</style></head><body><div class="wrap"><h1>لوحة مالك خدووم</h1>
